...
render() {
    return (
      ...
      <img className="u-expanded-width u-image u-image-1" src="images/Screenshot-2020-08-25-at-15.29.35.png" data-image-width="1387" data-image-height="622"/>
      <div className="u-clearfix u-gutter-26 u-layout-wrap u-layout-wrap-1">
        <div className="u-layout">
          <div className="u-layout-row">
            <div className="u-size-15 u-size-30-md">
              <div className="u-layout-col">
                ...
                <div className="u-align-center u-container-style u-grey-10 u-layout-cell u-size-40 u-layout-cell-2">
                  <div className="u-container-layout u-valign-top u-container-layout-2"><span className="u-file-icon u-icon u-icon-circle u-palette-3-base u-spacing-18 u-icon-1"><img src="images/839961.png" alt=""/></span>
                    <h5 className="u-custom-font u-font-roboto-condensed u-text u-text-1"> 24/7 technical support</h5>
                    <p className="u-text u-text-2"> We work hard to provide distinguished technical support services to our customers and respond to all inquiries.</p>
                    <a href="https://nicepage.com" className="u-active-none u-align-center u-border-1 u-border-active-grey-60 u-border-black u-border-hover-grey-60 u-btn u-button-style u-hover-none u-none u-text-body-color u-btn-1">more</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="u-layout-col">
                <div className="u-align-center u-container-style u-grey-10 u-layout-cell u-size-40 u-layout-cell-3">
                  <div className="u-container-layout u-valign-top u-container-layout-3"><span className="u-icon u-icon-circle u-palette-3-base u-spacing-18 u-icon-2"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 464 464"><use xlink="http://www.w3.org/1999/xlink" href="#svg-cfb3"></use></svg><svg className="u-svg-content" viewBox="0 0 464 464" x="0px" y="0px" id="svg-cfb3" style={{enableBackground:'new 0 0 464 464'}}><g><g><path d="M422.32,403.096l-48.68-62.584c15.774-4.713,29.4-14.801,38.512-28.512c11.464-19.816,6.28-44,1.264-67.36    c-3.033-12-4.848-24.276-5.416-36.64c0.566-12.375,2.38-24.662,5.416-36.672c4.984-23.376,10.2-47.544-1.264-67.328    c-11.872-20.512-35.776-28.104-58.896-35.432c-11.509-3.171-22.655-7.536-33.256-13.024c-9.62-6.24-18.552-13.48-26.648-21.6    C276.2,18.024,256.752,0,232,0s-44.2,18.024-61.36,33.936c-8.093,8.122-17.023,15.365-26.64,21.608    c-10.6,5.477-21.743,9.831-33.248,12.992c-23.12,7.328-47.024,14.92-58.896,35.432c-11.464,19.816-6.28,44-1.264,67.36    C53.625,183.339,55.437,195.625,56,208c-0.566,12.375-2.38,24.662-5.416,36.672c-4.984,23.376-10.2,47.544,1.264,67.328    c9.124,13.716,22.765,23.801,38.552,28.504l-48.72,62.584c-2.712,3.488-2.083,8.514,1.406,11.226    c1.676,1.303,3.8,1.886,5.906,1.622l57.2-7.144l14.12,49.408c0.827,2.896,3.211,5.082,6.168,5.656    c0.501,0.095,1.01,0.144,1.52,0.144c2.47,0.002,4.803-1.138,6.32-3.088l51.088-65.712c12.572,12.239,29.086,19.612,46.592,20.8    c17.506-1.188,34.02-8.561,46.592-20.8l51.088,65.688c1.512,1.959,3.845,3.108,6.32,3.112c0.51,0,1.019-0.049,1.52-0.144    c2.957-0.574,5.341-2.76,6.168-5.656l14.12-49.4l57.2,7.144c4.384,0.55,8.384-2.558,8.934-6.942    C424.206,406.896,423.623,404.772,422.32,403.096z M131.36,438.648L119.688,397.8c-1.085-3.789-4.769-6.223-8.68-5.736l-44.8,5.6    l40.152-51.616l4.424,1.416c11.494,3.163,22.626,7.517,33.216,12.992c9.62,6.24,18.552,13.48,26.648,21.6l2.752,2.544    L131.36,438.648z M232,400c-18.48,0-34.024-14.4-50.488-29.664c-8.957-8.949-18.851-16.906-29.512-23.736    c-11.599-6.072-23.809-10.899-36.424-14.4c-21.144-6.712-41.12-13.048-49.888-28.2c-8.368-14.472-4.048-34.64,0.536-56    c3.299-13.099,5.235-26.503,5.776-40c-0.538-13.497-2.471-26.901-5.768-40c-4.584-21.352-8.904-41.52-0.536-56    c8.8-15.152,28.744-21.488,49.888-28.2c12.613-3.502,24.819-8.329,36.416-14.4c10.658-6.83,20.55-14.788,29.504-23.736    C197.976,30.4,213.52,16,232,16s34.024,14.4,50.488,29.664C291.445,54.613,301.339,62.57,312,69.4    c11.599,6.072,23.809,10.899,36.424,14.4c21.144,6.712,41.12,13.048,49.888,28.2c8.368,14.472,4.048,34.64-0.536,56    c-3.299,13.099-5.235,26.503-5.776,40c0.538,13.497,2.471,26.901,5.768,40c4.584,21.352,8.904,41.52,0.536,56    c-8.8,15.152-28.744,21.488-49.888,28.2c-12.613,3.502-24.819,8.329-36.416,14.4c-10.658,6.83-20.55,14.788-29.504,23.736    C266.024,385.6,250.48,400,232,400z M353.032,392.064c-3.911-0.487-7.595,1.947-8.68,5.736l-11.712,40.848l-42.032-54.04    l2.752-2.544c8.093-8.122,17.023-15.365,26.64-21.608c10.6-5.477,21.743-9.831,33.248-12.992l4.424-1.416l40.16,51.616    L353.032,392.064z"></path>
                    ...
                    <h5 className="u-custom-font u-font-roboto-condensed u-text u-text-3"> Quick achievement</h5>
                    <p className="u-text u-text-4"> We strive to speed up the delivery of our services while providing clear answers to our customers.</p>
                    <a href="https://nicepage.com/c/sale-website-templates" className="u-active-none u-align-center u-border-1 u-border-active-grey-60 u-border-black u-border-hover-grey-60 u-btn u-button-style u-hover-none u-none u-text-body-color u-btn-2">more</a>
                  </div>
                </div>
            ...
            <div className="u-size-15 u-size-30-md">
              <div className="u-layout-col">
                <div className="u-container-style u-hidden-sm u-hidden-xs u-layout-cell u-size-20 u-layout-cell-5">
                  <div className="u-container-layout u-container-layout-5"></div>
                </div>
                <div className="u-align-center u-container-style u-grey-10 u-layout-cell u-size-40 u-layout-cell-6">
                  <div className="u-container-layout u-valign-top u-container-layout-6"><span className="u-file-icon u-icon u-icon-circle u-palette-3-base u-spacing-18 u-icon-3"><img src="images/96611.png" alt=""/></span>
                    <h5 className="u-custom-font u-font-roboto-condensed u-text u-text-5"> global services</h5>
                    <p className="u-text u-text-6"> We are working hard to develop our services in order to be the best and provide services of very high international quality.</p>
                    <a href="https://nicepage.com/k/radio-website-templates" className="u-active-none u-align-center u-border-1 u-border-active-grey-60 u-border-black u-border-hover-grey-60 u-btn u-button-style u-hover-none u-none u-text-body-color u-btn-3">more</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="u-size-15 u-size-30-md">
              <div className="u-layout-col">
                <div className="u-align-center u-container-style u-grey-10 u-layout-cell u-size-40 u-layout-cell-7">
                  <div className="u-container-layout u-valign-top u-container-layout-7"><span className="u-file-icon u-icon u-icon-circle u-palette-3-base u-spacing-18 u-icon-4"><img src="images/3501896.png" alt=""/></span>
                    <h5 className="u-custom-font u-font-roboto-condensed u-text u-text-7">Best Prices</h5>
                    <p className="u-text u-text-8">With us you'll always get the best available prices</p>
                    <a href="https://nicepage.com/website-templates" className="u-active-none u-align-center u-border-1 u-border-active-grey-60 u-border-black u-border-hover-grey-60 u-btn u-button-style u-hover-none u-none u-text-body-color u-btn-4">more</a>
                  </div>
                </div>
                <div className="u-container-style u-hidden-sm u-hidden-xs u-layout-cell u-size-20 u-layout-cell-8">
          ...
          <div className="u-layout-row">
            ...
            <div className="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-10">
              <div className="u-container-layout u-valign-middle u-container-layout-10">
                <p className="u-text u-text-10">Arroban Company will always be your best choice</p>
